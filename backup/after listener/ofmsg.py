...
class OFMSG(object):
    ...
    # create a packetout message using interest and feature data . reture a Data
    def create_packetout_data(self,interest,result_data): #todo need to check feature response
        return self.set_returndata(interest,result_data)
