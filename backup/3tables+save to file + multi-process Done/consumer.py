...
class Consumer(object):
    ...
    def run(self,packetin=False):
        ...
        if(packetin):
            prefixinquire_threed = Thread(target=self.prefixinquire)
...
#     parser.add_argument("-p", "--packetin",required=True, choices=[False,True], help='Send PacketIn ?')
#     args = parser.parse_args()
#
#     try:
#         packetin = args.packetin
#         Node().monitoring_function(packetin)
#
#     except:
